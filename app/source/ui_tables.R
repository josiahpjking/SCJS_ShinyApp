table_page <- 
  div(id="tables",
    ...
    div(class="tvar",
        ...
        selectizeInput("table_var",label="Choose Section of Survey",choices = c("Select All", names(all_vars[-1])), selected=names(all_vars)[2], multiple=T, options=list(maxItems=length(names(all_vars)))),
